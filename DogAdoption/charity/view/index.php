...
?>
      ...
      <section class="probootstrap-hero" style="background-image: url(../public/img/hero_bg_bw_1.jpg)"  data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
             <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                ...
                <p class="probootstrap-animate"><a href="adopt.php"  class="btn btn-primary btn-lg">Adopt Now</a></p>
                <p class="probootstrap-animate"><a href="buy.php" class="btn btn-primary btn-lg">Buy Now</a></p>
              </div>
            </div>
          </div>
        </div>
...
<!--              <div class="probootstrap-image-text-block  probootstrap-cause">-->
<!--                <figure>-->
<!--                  <img src="../public/img/img_sm_2.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                </figure>-->
<!--                <div class="probootstrap-cause-inner">-->
<!--                  <div class="progress">-->
...
<!--              <div class="probootstrap-image-text-block  probootstrap-cause">-->
<!--                <figure>-->
<!--                  <img src="../public/img/img_sm_3.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                </figure>-->
<!--                <div class="probootstrap-cause-inner">-->
<!--                  <div class="progress">-->
...
<!--          <div class="row">-->
<!--            <div class="col-md-12">-->
<!--              <p>Save the future for the little children by donating. <a href="causes.php">See all causes</a></p>-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
<!--      </section>-->
...
<!--      <section class="probootstrap-section probootstrap-bg probootstrap-section-dark" style="background-image: url(../public/img/hero_bg_bw_1.jpg)"  data-stellar-background-ratio="0.5">-->
<!--        <div class="container">-->
<!--          <div class="row">-->
<!--            <div class="col-md-12 text-center section-heading probootstrap-animate" data-animate-effect="fadeIn">-->
...
<!--              <h3>About Us</h3>-->
<!--              <p><img src="../public/img/img_sm_2.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>-->
...
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_1.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_1.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_2.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_2.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_3.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_3.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_4.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_4.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_5.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_5.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_6.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_6.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="item">-->
<!--                  <a href="../public/img/img_sq_7.jpg" class="image-popup">-->
<!--                    <img src="../public/img/img_sq_7.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">-->
<!--                  </a>-->
<!--                </div>-->
<!--              </div>-->
<!---->
...
<!--Designed &amp; Developed with <i class="icon icon-heart"></i> by <a href="https://uicookies.com/">uicookies.com</a>-->