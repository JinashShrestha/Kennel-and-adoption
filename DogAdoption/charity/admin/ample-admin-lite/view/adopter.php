    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">View Adopter</h4></div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="#">Dashboard</a></li>
                    <li class="active">View Adopter</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                    ...
                    <div class="row">
                        ...
                        <form action="" method="post">
                            ...
                            for ($page=1;$page<=$number_of_pages;$page++) {
                                echo '<span style="border:2px solid #b9def0; margin-right:3px; font-size: 25px"><a href="adopter.php? page=' . $page . '">' . $page . '</a> </span>';
                            }?>
                        </form>
                    </div>
                </div>
